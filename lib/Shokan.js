...
class Shokan {
  ...
  async deploy() {
    try {
      ...
      // Create revisionTime and assign to the Shokan revisionTime property
      ...
      // throw error and let the next class handle
      // maybe try + finally and leave a catch out in order to catch it in the shokan.js
      ...
      // Pass the connection as well as the Shokan instance object to the deployer
