...
export class GitDeployer extends AbstractDeployer {
  constructor(shokanInstance) {
    super(shokanInstance); // Call to parent constructor
    this.application = shokanInstance.application;
    this.conn = shokanInstance.conn;
    this.connectionConfig = shokanInstance.connectionConfig;
    this.repoDetails = shokanInstance.repoDetails;
    this.nodeVersion = shokanInstance.nodeVersion;
    ...
    this.revisionLogFile = shokanInstance.revisionLogFile;
    this.revision = "";
    this.revisionTime = shokanInstance.revisionTime;
    this.releases = shokanInstance.releases;
  }
